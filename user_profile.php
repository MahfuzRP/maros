        ...
        <div class="container">
            ...
            <div class="user_info">
                <div class="user_details">
                    <div class="details">
                    <h3><span style="color: #e3674d;">Hello,</span> <?php if(isset($username)){echo strtoupper($username);} ?></h3>
                </div>
                <div class="options">
                    <ul>
                        <li><a href="http://localhost/maros">Home</a></li>
                        <li><a href="http://localhost/maros/addtocart.php">View cart</a></li>
                        <li><a href="http://localhost/maros/category.php?status=catView&&id=30">View product</a></li>
                        <li><a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJvqJvcdTtzhqjrDjFSWtMVscHXjzjfznwvpNnbbqbbgSSgZwgtDZcPDVZqMHgRbTSVFjWL" target="_blank">Help</a></li>
                        <li class="last-a"><a href="?logoutuser=logout">Logout</a></li>
                    </ul>
                </div>
                </div>

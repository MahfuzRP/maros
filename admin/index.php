                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form action="" method="post" class="md-float-material">
                            <div class="text-center">
                                <img src="assets/logo-dark.png" style="width: 300px; margin-right: -220px; margin-bottom: -160px;" alt="logo.png">
                            </div>
                            <div class="auth-box">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left m-b-0">All Code by - MAHFUZ RP</p>
                                        <p class="text-inverse text-left"><b>Don't copy without permission</b></p>
                                    </div>
                                    <div class="col-md-2">
                                        <img src="assets/logo-light.png" style="width: 280px; margin-top: -15px; margin-left: -185px;" alt="small-logo.png">
                                    </div>
                                </div>

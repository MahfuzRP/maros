    ...
    <div class="col-lg-4 col-md-12">
        <div class="card">
            ...
            <div class="card-block"><iframe class="chartjs-hidden-iframe" tabindex="-1" style="display: block; overflow: hidden; border: 0px; margin: 0px; inset: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe><iframe class="chartjs-hidden-iframe" tabindex="-1" style="display: block; overflow: hidden; border: 0px; margin: 0px; inset: 0px; height: 100%; width: 100%; position: absolute; pointer-events: none; z-index: -1;"></iframe>
                ...
                <canvas id="feedback-chart" height="91" width="275" style="display: block; width: 275px; height: 91px;"></canvas>
            ...
            <div class="card-block">
                <ul class="feed-blog">
                    ...
                    <li class="diactive-feed">
                        ...
                        <p class="m-b-15 m-t-15" hii="" <b=""> @everone Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    </li>
                    <li class="active-feed">
                        <div class="feed-user-img">
                            <img src="assets/images/avatar-3.jpg" class="img-radius " alt="User-Profile-Image">
